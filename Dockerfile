...
RUN apt-get install -y oracle-java6-installer && rm -rf /var/cache/oracle-jdk6-installer
RUN apt-get install -y oracle-java7-installer && rm -rf /var/cache/oracle-jdk7-installer
RUN apt-get install -y oracle-java8-installer && rm -rf /var/cache/oracle-jdk8-installer
